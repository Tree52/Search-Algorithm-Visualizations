...
const binary: SearchAlgorithm = (
	target,
	A,
	leftIndex: number = 0,
	rightIndex: number = A.length - 1
) => {
...
const interpolation: SearchAlgorithm = (
	target,
	A,
	leftIndex: number = 0,
	rightIndex: number = A.length - 1
...
const ubiquitous: SearchAlgorithm = (
	target,
	A,
	leftIndex: number = 0,
	rightIndex: number = A.length - 1
